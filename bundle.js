...
var main = function () {
    ...
    var colors = ordinal(config.colors);
    colors.range(shuffle$2(colors.range()));
    ...
    function draw(selection, delay) {
        ...
        selection.classed(config.classes.solved, function (d) { return d.solved; });
        selection.classed(config.classes.revealed, function (d) { return d.revealed; });
    ...
    function onClick(card) {
        ...
        var move = revealCard(selection.data(), card);
        if (move.success) {
